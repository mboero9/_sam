...
<body>
		...
		while ($row = mysqli_fetch_array($query))
		{
			echo '<tr>
					...
					<td>'.$row['plazo'].'</td>
					<td><a href="vistaaccion.php?id='.$row['id'].'"><button class="btn btn-primary btn-sm" onclick="myFunction()">Ver accion</button></a></td>
					<td><a href="movimientos.php?id='.$row['id'].'"><button class="btn btn-primary btn-sm" onclick="myFunction()">Cargar Mov</button></a></td>
					<td><a href="movimientosxaccion.php?id='.$row['id'].'"><button class="btn btn-primary btn-sm" onclick="myFunction()">Ver Mov</button></a></td>	
</div>					
				</tr>';
		}?>
		</tbody>
